        ...
        (t = function () {
          return (function (o) {
            ...
            function r(t) {
              ...
              return (
                o[t].call(c.exports, c, c.exports, r), (c.l = !0), c.exports
              );
            }
            return (
              (r.m = o),
            ...
            function (o, e, r) {
              ...
              function B(o) {
                    ...
                    (t.ecBlocks.forEach(function (o) {
                      for (var e = 0; e < o.numBlocks; e++)
                        c.push({
                          ...
                          (s +=
                            o.dataCodewordsPerBlock + t.ecCodewordsPerBlock);
                    }),
                    o.length < s)
                  )
                    return null;
                ...
                if (!B) return null;
                for (
                  var k = B.reduce(function (o, e) {
                      return o + e.numDataCodewords;
                    }, 0),
                    u = new Uint8ClampedArray(k),
                    C = 0,
                    m = 0,
                    f = B;
                  m < f.length;
                  ...
                  if (!P) return null;
                  for (var v = 0; v < w.numDataCodewords; v++) u[C++] = P[v];
                }
                try {
                  return c.decode(u, e.versionNumber);
                } catch (o) {
                  return null;
                }
              }
                  ...
                  (o.prototype.readBits = function (o) {
                    ...
                    if (o > 0) {
                      ...
                      o > 0 &&
                        ((c = (255 >> (s = 8 - o)) << s),
                        (e =
                          (e << o) | ((this.bytes[this.byteOffset] & c) >> s)),
                        (this.bitOffset += o));
                    }
                    return e;
                  }),
              ...
              e.extract = function (o, e) {
                for (
                  var r,
                      ...
                      ((s = {
                        a11:
                          (k = c(
                            ...
                            k.a33 -
                          k.a23 * k.a32,
                        a12: k.a13 * k.a32 - k.a12 * k.a33,
                        a13: k.a12 * k.a23 - k.a13 * k.a22,
                        a21: k.a23 * k.a31 - k.a21 * k.a33,
                        a22: k.a11 * k.a33 - k.a13 * k.a31,
                        a23: k.a13 * k.a21 - k.a11 * k.a23,
                        a31: k.a21 * k.a32 - k.a22 * k.a31,
                        a32: k.a12 * k.a31 - k.a11 * k.a32,
                        a33: k.a11 * k.a22 - k.a12 * k.a21,
                      }),
                      {
                        a11:
                          (r = c(
                    ...
                    d = t.BitMatrix.createEmpty(e.dimension, e.dimension),
                    n = function (o, e) {
                      var r = a.a13 * o + a.a23 * e + a.a33;
                      return {
                        x: (a.a11 * o + a.a21 * e + a.a31) / r,
                        y: (a.a12 * o + a.a22 * e + a.a32) / r,
                      };
                    },
                    l = 0;
                  l < e.dimension;
                  ...
                  for (var i = 0; i < e.dimension; i++) {
                    var B = n(i + 0.5, l + 0.5);
                    d.set(i, l, o.get(Math.floor(B.x), Math.floor(B.y)));
                  }
                var k;
                return { matrix: d, mappingFunction: n };
              };
            },
            function (o, e, r) {
              Object.defineProperty(e, "__esModule", { value: !0 });
              ...
              e.locate = function (o) {
                ...
                var u = (function (o, e, r) {
                    ...
                    return (
                      k >= B && k >= u
                        ? ((n = (c = [e, o, r])[0]), (l = c[1]), (i = c[2]))
                        : u >= k && u >= B
                        ? ((n = (s = [o, e, r])[0]), (l = s[1]), (i = s[2]))
                        : ((n = (a = [o, r, e])[0]), (l = a[1]), (i = a[2])),
                      (i.x - l.x) * (n.y - l.y) - (i.y - l.y) * (n.x - l.x) <
                        0 && ((n = (d = [i, n])[0]), (i = d[1])),
